...
folders = {'benchmark':'Benchmark','exact_macro':'Exact macrosolution', 'exact_integral':'Exact integral'}
for folder in folders:
    plot_convergence('%s/linear_convergence_table.txt'%folder,'%s (linear map)'%folders[folder])
    plot_convergence('%s/non_linear_convergence_table.txt'%folder,'%s (non-linear map)'%folders[folder])
