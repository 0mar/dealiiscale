...
\subsection{Problem descroption}
\label{sub:problem_descroption}
...
\begin{align}
    ...
    \label{eq:man_para}&- \Delta_y \rho(x,y) = -\Delta_y r(y) &\mbox{ in }  \Omega\times Y \\
